            ...
            {resultado && (
                <div className="mt-6 p-4 bg-green-50 border border-green-200 rounded-lg">
                    ...
                    <div className="grid sm:grid-cols-2 gap-3 text-sm text-slate-700">
                        <div>
                            <span className="text-3xl">Estado:</span> <span className="text-4xl font-bold">{resultado.estado}</span>
                        </div>
                        <div>
                            <span className="text-3xl">Consumo:</span> <span className="text-4xl font-bold">{resultado.consumo} kWh</span>
                        </div>
                        <div>
                            <span className="text-3xl">Tarifa:</span><span className="text-4xl font-bold"> R$ {resultado.tarifa.toFixed(3)}/kWh</span> 
                        </div>
                        <div>
                            <span className="text-3xl">Custo Atual:</span> <span className="text-4xl font-bold"> R$ {resultado.custoAtual}</span>
                        </div>
                        <div className="text-green-700">
                            <span className="text-3xl">Economia Estimada (15%):</span> <span className="text-4xl font-bold"> R$ {resultado.economia}</span>
                        </div>
                        <div className="text-green-700">
                            <span className="text-3xl">Custo com Energia Solar:</span> <span className="text-4xl font-bold"> R$ {resultado.custoComEnergiaSolar}</span>
                        </div>
                    </div>
                </div>
            )}
